...
# define GLH_CORE_1_2_NAME(a) GLH__PREPROCESSOR_GYMNASTICS(GLH_CORE_1_2_PREFIX,a)
    ...
    GLH_EXTERN PFNGLCOLORSUBTABLEPROC GLH_CORE_1_2_NAME(glColorSubTable) GLH_INITIALIZER;
    GLH_EXTERN PFNGLCOPYCOLORSUBTABLEPROC GLH_CORE_1_2_NAME(glCopyColorSubTable) GLH_INITIALIZER;
    GLH_EXTERN PFNGLCONVOLUTIONFILTER1DPROC GLH_CORE_1_2_NAME(glConvolutionFilter1D) GLH_INITIALIZER;
    GLH_EXTERN PFNGLCONVOLUTIONFILTER2DPROC GLH_CORE_1_2_NAME(glConvolutionFilter2D) GLH_INITIALIZER;
    GLH_EXTERN PFNGLCONVOLUTIONPARAMETERFPROC GLH_CORE_1_2_NAME(glConvolutionParameterf) GLH_INITIALIZER;
    GLH_EXTERN PFNGLCONVOLUTIONPARAMETERFVPROC GLH_CORE_1_2_NAME(glConvolutionParameterfv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLCONVOLUTIONPARAMETERIPROC GLH_CORE_1_2_NAME(glConvolutionParameteri) GLH_INITIALIZER;
    GLH_EXTERN PFNGLCONVOLUTIONPARAMETERIVPROC GLH_CORE_1_2_NAME(glConvolutionParameteriv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLCOPYCONVOLUTIONFILTER1DPROC GLH_CORE_1_2_NAME(glCopyConvolutionFilter1D) GLH_INITIALIZER;
    GLH_EXTERN PFNGLCOPYCONVOLUTIONFILTER2DPROC GLH_CORE_1_2_NAME(glCopyConvolutionFilter2D) GLH_INITIALIZER;
    GLH_EXTERN PFNGLGETCONVOLUTIONFILTERPROC GLH_CORE_1_2_NAME(glGetConvolutionFilter) GLH_INITIALIZER;
    GLH_EXTERN PFNGLGETCONVOLUTIONPARAMETERFVPROC GLH_CORE_1_2_NAME(glGetConvolutionParameterfv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLGETCONVOLUTIONPARAMETERIVPROC GLH_CORE_1_2_NAME(glGetConvolutionParameteriv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLGETSEPARABLEFILTERPROC GLH_CORE_1_2_NAME(glGetSeparableFilter) GLH_INITIALIZER;
    GLH_EXTERN PFNGLSEPARABLEFILTER2DPROC GLH_CORE_1_2_NAME(glSeparableFilter2D) GLH_INITIALIZER;
    GLH_EXTERN PFNGLGETHISTOGRAMPROC GLH_CORE_1_2_NAME(glGetHistogram) GLH_INITIALIZER;
    GLH_EXTERN PFNGLGETHISTOGRAMPARAMETERFVPROC GLH_CORE_1_2_NAME(glGetHistogramParameterfv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLGETHISTOGRAMPARAMETERIVPROC GLH_CORE_1_2_NAME(glGetHistogramParameteriv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLGETMINMAXPROC GLH_CORE_1_2_NAME(glGetMinmax) GLH_INITIALIZER;
    GLH_EXTERN PFNGLGETMINMAXPARAMETERFVPROC GLH_CORE_1_2_NAME(glGetMinmaxParameterfv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLGETMINMAXPARAMETERIVPROC GLH_CORE_1_2_NAME(glGetMinmaxParameteriv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLHISTOGRAMPROC GLH_CORE_1_2_NAME(glHistogram) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMINMAXPROC GLH_CORE_1_2_NAME(glMinmax) GLH_INITIALIZER;
    GLH_EXTERN PFNGLRESETHISTOGRAMPROC GLH_CORE_1_2_NAME(glResetHistogram) GLH_INITIALIZER;
    GLH_EXTERN PFNGLRESETMINMAXPROC GLH_CORE_1_2_NAME(glResetMinmax) GLH_INITIALIZER;
    ...
    GLH_EXTERN PFNGLMULTITEXCOORD1DPROC GLH_CORE_1_2_NAME(glMultiTexCoord1d) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD1DVPROC GLH_CORE_1_2_NAME(glMultiTexCoord1dv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD1FPROC GLH_CORE_1_2_NAME(glMultiTexCoord1f) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD1FVPROC GLH_CORE_1_2_NAME(glMultiTexCoord1fv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD1IPROC GLH_CORE_1_2_NAME(glMultiTexCoord1i) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD1IVPROC GLH_CORE_1_2_NAME(glMultiTexCoord1iv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD1SPROC GLH_CORE_1_2_NAME(glMultiTexCoord1s) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD1SVPROC GLH_CORE_1_2_NAME(glMultiTexCoord1sv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD2DPROC GLH_CORE_1_2_NAME(glMultiTexCoord2d) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD2DVPROC GLH_CORE_1_2_NAME(glMultiTexCoord2dv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD2FPROC GLH_CORE_1_2_NAME(glMultiTexCoord2f) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD2FVPROC GLH_CORE_1_2_NAME(glMultiTexCoord2fv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD2IPROC GLH_CORE_1_2_NAME(glMultiTexCoord2i) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD2IVPROC GLH_CORE_1_2_NAME(glMultiTexCoord2iv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD2SPROC GLH_CORE_1_2_NAME(glMultiTexCoord2s) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD2SVPROC GLH_CORE_1_2_NAME(glMultiTexCoord2sv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD3DPROC GLH_CORE_1_2_NAME(glMultiTexCoord3d) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD3DVPROC GLH_CORE_1_2_NAME(glMultiTexCoord3dv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD3FPROC GLH_CORE_1_2_NAME(glMultiTexCoord3f) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD3FVPROC GLH_CORE_1_2_NAME(glMultiTexCoord3fv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD3IPROC GLH_CORE_1_2_NAME(glMultiTexCoord3i) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD3IVPROC GLH_CORE_1_2_NAME(glMultiTexCoord3iv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD3SPROC GLH_CORE_1_2_NAME(glMultiTexCoord3s) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD3SVPROC GLH_CORE_1_2_NAME(glMultiTexCoord3sv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD4DPROC GLH_CORE_1_2_NAME(glMultiTexCoord4d) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD4DVPROC GLH_CORE_1_2_NAME(glMultiTexCoord4dv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD4FPROC GLH_CORE_1_2_NAME(glMultiTexCoord4f) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD4FVPROC GLH_CORE_1_2_NAME(glMultiTexCoord4fv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD4IPROC GLH_CORE_1_2_NAME(glMultiTexCoord4i) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD4IVPROC GLH_CORE_1_2_NAME(glMultiTexCoord4iv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD4SPROC GLH_CORE_1_2_NAME(glMultiTexCoord4s) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTITEXCOORD4SVPROC GLH_CORE_1_2_NAME(glMultiTexCoord4sv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLACTIVETEXTUREPROC GLH_CORE_1_2_NAME(glActiveTexture) GLH_INITIALIZER;
    GLH_EXTERN PFNGLCLIENTACTIVETEXTUREPROC GLH_CORE_1_2_NAME(glClientActiveTexture) GLH_INITIALIZER;
#endif
#endif

#ifdef GL_VERSION_1_3
    GLH_EXTERN PFNGLCOMPRESSEDTEXIMAGE3DPROC GLH_EXT_NAME(glCompressedTexImage3D) GLH_INITIALIZER;
    GLH_EXTERN PFNGLCOMPRESSEDTEXIMAGE2DPROC GLH_EXT_NAME(glCompressedTexImage2D) GLH_INITIALIZER;
    GLH_EXTERN PFNGLCOMPRESSEDTEXIMAGE1DPROC GLH_EXT_NAME(glCompressedTexImage1D) GLH_INITIALIZER;
    GLH_EXTERN PFNGLCOMPRESSEDTEXSUBIMAGE3DPROC GLH_EXT_NAME(glCompressedTexSubImage3D) GLH_INITIALIZER;
    GLH_EXTERN PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC GLH_EXT_NAME(glCompressedTexSubImage2D) GLH_INITIALIZER;
    ...
    GLH_EXTERN PFNGLSAMPLECOVERAGEPROC GLH_EXT_NAME(glSampleCoverage) GLH_INITIALIZER;
    GLH_EXTERN PFNGLLOADTRANSPOSEMATRIXFPROC GLH_EXT_NAME(glLoadTransposeMatrixf) GLH_INITIALIZER;
    GLH_EXTERN PFNGLLOADTRANSPOSEMATRIXDPROC GLH_EXT_NAME(glLoadTransposeMatrixd) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTTRANSPOSEMATRIXFPROC GLH_EXT_NAME(glMultTransposeMatrixf) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTTRANSPOSEMATRIXDPROC GLH_EXT_NAME(glMultTransposeMatrixd) GLH_INITIALIZER;
#endif

#ifdef GL_VERSION_1_4
    GLH_EXTERN PFNGLMULTIDRAWARRAYSPROC GLH_EXT_NAME(glMultiDrawArrays) GLH_INITIALIZER;
    GLH_EXTERN PFNGLMULTIDRAWELEMENTSPROC GLH_EXT_NAME(glMultiDrawElements) GLH_INITIALIZER;
    GLH_EXTERN PFNGLPOINTPARAMETERFPROC GLH_EXT_NAME(glPointParameterf) GLH_INITIALIZER;
    GLH_EXTERN PFNGLPOINTPARAMETERFVPROC GLH_EXT_NAME(glPointParameterfv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLSECONDARYCOLOR3BPROC GLH_EXT_NAME(glSecondaryColor3b) GLH_INITIALIZER;
    GLH_EXTERN PFNGLSECONDARYCOLOR3BVPROC GLH_EXT_NAME(glSecondaryColor3bv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLSECONDARYCOLOR3DPROC GLH_EXT_NAME(glSecondaryColor3d) GLH_INITIALIZER;
    GLH_EXTERN PFNGLSECONDARYCOLOR3DVPROC GLH_EXT_NAME(glSecondaryColor3dv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLSECONDARYCOLOR3FPROC GLH_EXT_NAME(glSecondaryColor3f) GLH_INITIALIZER;
    GLH_EXTERN PFNGLSECONDARYCOLOR3FVPROC GLH_EXT_NAME(glSecondaryColor3fv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLSECONDARYCOLOR3IPROC GLH_EXT_NAME(glSecondaryColor3i) GLH_INITIALIZER;
    GLH_EXTERN PFNGLSECONDARYCOLOR3IVPROC GLH_EXT_NAME(glSecondaryColor3iv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLSECONDARYCOLOR3SPROC GLH_EXT_NAME(glSecondaryColor3s) GLH_INITIALIZER;
    GLH_EXTERN PFNGLSECONDARYCOLOR3SVPROC GLH_EXT_NAME(glSecondaryColor3sv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLSECONDARYCOLOR3UBPROC GLH_EXT_NAME(glSecondaryColor3ub) GLH_INITIALIZER;
    GLH_EXTERN PFNGLSECONDARYCOLOR3UBVPROC GLH_EXT_NAME(glSecondaryColor3ubv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLSECONDARYCOLOR3UIPROC GLH_EXT_NAME(glSecondaryColor3ui) GLH_INITIALIZER;
    GLH_EXTERN PFNGLSECONDARYCOLOR3UIVPROC GLH_EXT_NAME(glSecondaryColor3uiv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLSECONDARYCOLOR3USPROC GLH_EXT_NAME(glSecondaryColor3us) GLH_INITIALIZER;
    GLH_EXTERN PFNGLSECONDARYCOLOR3USVPROC GLH_EXT_NAME(glSecondaryColor3usv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLSECONDARYCOLORPOINTERPROC GLH_EXT_NAME(glSecondaryColorPointer) GLH_INITIALIZER;
    GLH_EXTERN PFNGLBLENDFUNCSEPARATEPROC GLH_EXT_NAME(glBlendFuncSeparate) GLH_INITIALIZER;
    GLH_EXTERN PFNGLWINDOWPOS2DPROC GLH_EXT_NAME(glWindowPos2d) GLH_INITIALIZER;
    GLH_EXTERN PFNGLWINDOWPOS2FPROC GLH_EXT_NAME(glWindowPos2f) GLH_INITIALIZER;
    GLH_EXTERN PFNGLWINDOWPOS2IPROC GLH_EXT_NAME(glWindowPos2i) GLH_INITIALIZER;
    GLH_EXTERN PFNGLWINDOWPOS2SPROC GLH_EXT_NAME(glWindowPos2s) GLH_INITIALIZER;
    GLH_EXTERN PFNGLWINDOWPOS2DVPROC GLH_EXT_NAME(glWindowPos2dv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLWINDOWPOS2FVPROC GLH_EXT_NAME(glWindowPos2fv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLWINDOWPOS2IVPROC GLH_EXT_NAME(glWindowPos2iv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLWINDOWPOS2SVPROC GLH_EXT_NAME(glWindowPos2sv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLWINDOWPOS3DPROC GLH_EXT_NAME(glWindowPos3d) GLH_INITIALIZER;
    GLH_EXTERN PFNGLWINDOWPOS3FPROC GLH_EXT_NAME(glWindowPos3f) GLH_INITIALIZER;
    GLH_EXTERN PFNGLWINDOWPOS3IPROC GLH_EXT_NAME(glWindowPos3i) GLH_INITIALIZER;
    GLH_EXTERN PFNGLWINDOWPOS3SPROC GLH_EXT_NAME(glWindowPos3s) GLH_INITIALIZER;
    GLH_EXTERN PFNGLWINDOWPOS3DVPROC GLH_EXT_NAME(glWindowPos3dv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLWINDOWPOS3FVPROC GLH_EXT_NAME(glWindowPos3fv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLWINDOWPOS3IVPROC GLH_EXT_NAME(glWindowPos3iv) GLH_INITIALIZER;
    GLH_EXTERN PFNGLWINDOWPOS3SVPROC GLH_EXT_NAME(glWindowPos3sv) GLH_INITIALIZER;
#endif
...
int glh_init_extension(const char* extension)
{
    if (NULL == extension) {
        ...
        if (NULL == GLH_CORE_1_2_NAME(glGetColorTableParameteriv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glColorSubTable) = (PFNGLCOLORSUBTABLEPROC)GLH_EXT_GET_PROC_ADDRESS("glColorSubTable");
        if (NULL == GLH_CORE_1_2_NAME(glColorSubTable))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glCopyColorSubTable) = (PFNGLCOPYCOLORSUBTABLEPROC)GLH_EXT_GET_PROC_ADDRESS("glCopyColorSubTable");
        if (NULL == GLH_CORE_1_2_NAME(glCopyColorSubTable))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glConvolutionFilter1D) = (PFNGLCONVOLUTIONFILTER1DPROC)GLH_EXT_GET_PROC_ADDRESS("glConvolutionFilter1D");
        if (NULL == GLH_CORE_1_2_NAME(glConvolutionFilter1D))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glConvolutionFilter2D) = (PFNGLCONVOLUTIONFILTER2DPROC)GLH_EXT_GET_PROC_ADDRESS("glConvolutionFilter2D");
        if (NULL == GLH_CORE_1_2_NAME(glConvolutionFilter2D))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glConvolutionParameterf) = (PFNGLCONVOLUTIONPARAMETERFPROC)GLH_EXT_GET_PROC_ADDRESS("glConvolutionParameterf");
        if (NULL == GLH_CORE_1_2_NAME(glConvolutionParameterf))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glConvolutionParameterfv) = (PFNGLCONVOLUTIONPARAMETERFVPROC)GLH_EXT_GET_PROC_ADDRESS("glConvolutionParameterfv");
        if (NULL == GLH_CORE_1_2_NAME(glConvolutionParameterfv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glConvolutionParameteri) = (PFNGLCONVOLUTIONPARAMETERIPROC)GLH_EXT_GET_PROC_ADDRESS("glConvolutionParameteri");
        if (NULL == GLH_CORE_1_2_NAME(glConvolutionParameteri))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glConvolutionParameteriv) = (PFNGLCONVOLUTIONPARAMETERIVPROC)GLH_EXT_GET_PROC_ADDRESS("glConvolutionParameteriv");
        if (NULL == GLH_CORE_1_2_NAME(glConvolutionParameteriv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glCopyConvolutionFilter1D) = (PFNGLCOPYCONVOLUTIONFILTER1DPROC)GLH_EXT_GET_PROC_ADDRESS("glCopyConvolutionFilter1D");
        if (NULL == GLH_CORE_1_2_NAME(glCopyConvolutionFilter1D))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glCopyConvolutionFilter2D) = (PFNGLCOPYCONVOLUTIONFILTER2DPROC)GLH_EXT_GET_PROC_ADDRESS("glCopyConvolutionFilter2D");
        if (NULL == GLH_CORE_1_2_NAME(glCopyConvolutionFilter2D))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glGetConvolutionFilter) = (PFNGLGETCONVOLUTIONFILTERPROC)GLH_EXT_GET_PROC_ADDRESS("glGetConvolutionFilter");
        if (NULL == GLH_CORE_1_2_NAME(glGetConvolutionFilter))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glGetConvolutionParameterfv) = (PFNGLGETCONVOLUTIONPARAMETERFVPROC)GLH_EXT_GET_PROC_ADDRESS("glGetConvolutionParameterfv");
        if (NULL == GLH_CORE_1_2_NAME(glGetConvolutionParameterfv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glGetConvolutionParameteriv) = (PFNGLGETCONVOLUTIONPARAMETERIVPROC)GLH_EXT_GET_PROC_ADDRESS("glGetConvolutionParameteriv");
        if (NULL == GLH_CORE_1_2_NAME(glGetConvolutionParameteriv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glGetSeparableFilter) = (PFNGLGETSEPARABLEFILTERPROC)GLH_EXT_GET_PROC_ADDRESS("glGetSeparableFilter");
        if (NULL == GLH_CORE_1_2_NAME(glGetSeparableFilter))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glSeparableFilter2D) = (PFNGLSEPARABLEFILTER2DPROC)GLH_EXT_GET_PROC_ADDRESS("glSeparableFilter2D");
        if (NULL == GLH_CORE_1_2_NAME(glSeparableFilter2D))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glGetHistogram) = (PFNGLGETHISTOGRAMPROC)GLH_EXT_GET_PROC_ADDRESS("glGetHistogram");
        if (NULL == GLH_CORE_1_2_NAME(glGetHistogram))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glGetHistogramParameterfv) = (PFNGLGETHISTOGRAMPARAMETERFVPROC)GLH_EXT_GET_PROC_ADDRESS("glGetHistogramParameterfv");
        if (NULL == GLH_CORE_1_2_NAME(glGetHistogramParameterfv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glGetHistogramParameteriv) = (PFNGLGETHISTOGRAMPARAMETERIVPROC)GLH_EXT_GET_PROC_ADDRESS("glGetHistogramParameteriv");
        if (NULL == GLH_CORE_1_2_NAME(glGetHistogramParameteriv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glGetMinmax) = (PFNGLGETMINMAXPROC)GLH_EXT_GET_PROC_ADDRESS("glGetMinmax");
        if (NULL == GLH_CORE_1_2_NAME(glGetMinmax))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glGetMinmaxParameterfv) = (PFNGLGETMINMAXPARAMETERFVPROC)GLH_EXT_GET_PROC_ADDRESS("glGetMinmaxParameterfv");
        if (NULL == GLH_CORE_1_2_NAME(glGetMinmaxParameterfv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glGetMinmaxParameteriv) = (PFNGLGETMINMAXPARAMETERIVPROC)GLH_EXT_GET_PROC_ADDRESS("glGetMinmaxParameteriv");
        if (NULL == GLH_CORE_1_2_NAME(glGetMinmaxParameteriv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glHistogram) = (PFNGLHISTOGRAMPROC)GLH_EXT_GET_PROC_ADDRESS("glHistogram");
        if (NULL == GLH_CORE_1_2_NAME(glHistogram))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMinmax) = (PFNGLMINMAXPROC)GLH_EXT_GET_PROC_ADDRESS("glMinmax");
        if (NULL == GLH_CORE_1_2_NAME(glMinmax))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glResetHistogram) = (PFNGLRESETHISTOGRAMPROC)GLH_EXT_GET_PROC_ADDRESS("glResetHistogram");
        if (NULL == GLH_CORE_1_2_NAME(glResetHistogram))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glResetMinmax) = (PFNGLRESETMINMAXPROC)GLH_EXT_GET_PROC_ADDRESS("glResetMinmax");
        if (NULL == GLH_CORE_1_2_NAME(glResetMinmax))
            return GL_FALSE;
        ...
        if (NULL == GLH_CORE_1_2_NAME(glCopyTexSubImage3D))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord1d) = (PFNGLMULTITEXCOORD1DPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord1d");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord1d))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord1dv) = (PFNGLMULTITEXCOORD1DVPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord1dv");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord1dv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord1f) = (PFNGLMULTITEXCOORD1FPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord1f");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord1f))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord1fv) = (PFNGLMULTITEXCOORD1FVPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord1fv");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord1fv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord1i) = (PFNGLMULTITEXCOORD1IPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord1i");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord1i))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord1iv) = (PFNGLMULTITEXCOORD1IVPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord1iv");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord1iv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord1s) = (PFNGLMULTITEXCOORD1SPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord1s");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord1s))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord1sv) = (PFNGLMULTITEXCOORD1SVPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord1sv");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord1sv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord2d) = (PFNGLMULTITEXCOORD2DPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord2d");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord2d))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord2dv) = (PFNGLMULTITEXCOORD2DVPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord2dv");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord2dv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord2f) = (PFNGLMULTITEXCOORD2FPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord2f");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord2f))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord2fv) = (PFNGLMULTITEXCOORD2FVPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord2fv");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord2fv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord2i) = (PFNGLMULTITEXCOORD2IPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord2i");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord2i))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord2iv) = (PFNGLMULTITEXCOORD2IVPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord2iv");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord2iv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord2s) = (PFNGLMULTITEXCOORD2SPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord2s");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord2s))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord2sv) = (PFNGLMULTITEXCOORD2SVPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord2sv");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord2sv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord3d) = (PFNGLMULTITEXCOORD3DPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord3d");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord3d))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord3dv) = (PFNGLMULTITEXCOORD3DVPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord3dv");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord3dv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord3f) = (PFNGLMULTITEXCOORD3FPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord3f");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord3f))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord3fv) = (PFNGLMULTITEXCOORD3FVPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord3fv");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord3fv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord3i) = (PFNGLMULTITEXCOORD3IPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord3i");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord3i))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord3iv) = (PFNGLMULTITEXCOORD3IVPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord3iv");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord3iv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord3s) = (PFNGLMULTITEXCOORD3SPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord3s");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord3s))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord3sv) = (PFNGLMULTITEXCOORD3SVPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord3sv");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord3sv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord4d) = (PFNGLMULTITEXCOORD4DPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord4d");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord4d))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord4dv) = (PFNGLMULTITEXCOORD4DVPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord4dv");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord4dv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord4f) = (PFNGLMULTITEXCOORD4FPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord4f");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord4f))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord4fv) = (PFNGLMULTITEXCOORD4FVPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord4fv");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord4fv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord4i) = (PFNGLMULTITEXCOORD4IPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord4i");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord4i))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord4iv) = (PFNGLMULTITEXCOORD4IVPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord4iv");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord4iv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord4s) = (PFNGLMULTITEXCOORD4SPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord4s");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord4s))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glMultiTexCoord4sv) = (PFNGLMULTITEXCOORD4SVPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiTexCoord4sv");
        if (NULL == GLH_CORE_1_2_NAME(glMultiTexCoord4sv))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glActiveTexture) = (PFNGLACTIVETEXTUREPROC)GLH_EXT_GET_PROC_ADDRESS("glActiveTexture");
        if (NULL == GLH_CORE_1_2_NAME(glActiveTexture))
            return GL_FALSE;
        GLH_CORE_1_2_NAME(glClientActiveTexture) = (PFNGLCLIENTACTIVETEXTUREPROC)GLH_EXT_GET_PROC_ADDRESS("glClientActiveTexture");
        if (NULL == GLH_CORE_1_2_NAME(glClientActiveTexture))
            return GL_FALSE;
#endif
#endif
        ...
        GLH_EXT_NAME(glCompressedTexImage3D) = (PFNGLCOMPRESSEDTEXIMAGE3DPROC)GLH_EXT_GET_PROC_ADDRESS("glCompressedTexImage3D");
        if (NULL == GLH_EXT_NAME(glCompressedTexImage3D))
            return GL_FALSE;
        GLH_EXT_NAME(glCompressedTexImage2D) = (PFNGLCOMPRESSEDTEXIMAGE2DPROC)GLH_EXT_GET_PROC_ADDRESS("glCompressedTexImage2D");
        if (NULL == GLH_EXT_NAME(glCompressedTexImage2D))
            return GL_FALSE;
        GLH_EXT_NAME(glCompressedTexImage1D) = (PFNGLCOMPRESSEDTEXIMAGE1DPROC)GLH_EXT_GET_PROC_ADDRESS("glCompressedTexImage1D");
        if (NULL == GLH_EXT_NAME(glCompressedTexImage1D))
            return GL_FALSE;
        GLH_EXT_NAME(glCompressedTexSubImage3D) = (PFNGLCOMPRESSEDTEXSUBIMAGE3DPROC)GLH_EXT_GET_PROC_ADDRESS("glCompressedTexSubImage3D");
        if (NULL == GLH_EXT_NAME(glCompressedTexSubImage3D))
            return GL_FALSE;
        GLH_EXT_NAME(glCompressedTexSubImage2D) = (PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC)GLH_EXT_GET_PROC_ADDRESS("glCompressedTexSubImage2D");
        if (NULL == GLH_EXT_NAME(glCompressedTexSubImage2D))
            return GL_FALSE;
        GLH_EXT_NAME(glCompressedTexSubImage1D) = (PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC)GLH_EXT_GET_PROC_ADDRESS("glCompressedTexSubImage1D");
        if (NULL == GLH_EXT_NAME(glCompressedTexSubImage1D))
            return GL_FALSE;
        GLH_EXT_NAME(glGetCompressedTexImage) = (PFNGLGETCOMPRESSEDTEXIMAGEPROC)GLH_EXT_GET_PROC_ADDRESS("glGetCompressedTexImage");
        if (NULL == GLH_EXT_NAME(glGetCompressedTexImage))
            return GL_FALSE;
        GLH_EXT_NAME(glSampleCoverage) = (PFNGLSAMPLECOVERAGEPROC)GLH_EXT_GET_PROC_ADDRESS("glSampleCoverage");
        if (NULL == GLH_EXT_NAME(glSampleCoverage))
            return GL_FALSE;
        GLH_EXT_NAME(glLoadTransposeMatrixf) = (PFNGLLOADTRANSPOSEMATRIXFPROC)GLH_EXT_GET_PROC_ADDRESS("glLoadTransposeMatrixf");
        if (NULL == GLH_EXT_NAME(glLoadTransposeMatrixf))
            return GL_FALSE;
        GLH_EXT_NAME(glLoadTransposeMatrixd) = (PFNGLLOADTRANSPOSEMATRIXDPROC)GLH_EXT_GET_PROC_ADDRESS("glLoadTransposeMatrixd");
        if (NULL == GLH_EXT_NAME(glLoadTransposeMatrixd))
            return GL_FALSE;
        GLH_EXT_NAME(glMultTransposeMatrixf) = (PFNGLMULTTRANSPOSEMATRIXFPROC)GLH_EXT_GET_PROC_ADDRESS("glMultTransposeMatrixf");
        if (NULL == GLH_EXT_NAME(glMultTransposeMatrixf))
            return GL_FALSE;
        GLH_EXT_NAME(glMultTransposeMatrixd) = (PFNGLMULTTRANSPOSEMATRIXDPROC)GLH_EXT_GET_PROC_ADDRESS("glMultTransposeMatrixd");
        if (NULL == GLH_EXT_NAME(glMultTransposeMatrixd))
            return GL_FALSE;
#endif

#ifdef GL_VERSION_1_4
    } else if (0 == strcmp(extension, "GL_VERSION_1_4")) {
        GLH_EXT_NAME(glMultiDrawArrays) = (PFNGLMULTIDRAWARRAYSPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiDrawArrays");
        if (NULL == GLH_EXT_NAME(glMultiDrawArrays))
            return GL_FALSE;
        GLH_EXT_NAME(glMultiDrawElements) = (PFNGLMULTIDRAWELEMENTSPROC)GLH_EXT_GET_PROC_ADDRESS("glMultiDrawElements");
        if (NULL == GLH_EXT_NAME(glMultiDrawElements))
            return GL_FALSE;
        GLH_EXT_NAME(glPointParameterf) = (PFNGLPOINTPARAMETERFPROC)GLH_EXT_GET_PROC_ADDRESS("glPointParameterf");
        if (NULL == GLH_EXT_NAME(glPointParameterf))
            return GL_FALSE;
        GLH_EXT_NAME(glPointParameterfv) = (PFNGLPOINTPARAMETERFVPROC)GLH_EXT_GET_PROC_ADDRESS("glPointParameterfv");
        if (NULL == GLH_EXT_NAME(glPointParameterfv))
            return GL_FALSE;
        GLH_EXT_NAME(glSecondaryColor3b) = (PFNGLSECONDARYCOLOR3BPROC)GLH_EXT_GET_PROC_ADDRESS("glSecondaryColor3b");
        if (NULL == GLH_EXT_NAME(glSecondaryColor3b))
            return GL_FALSE;
        GLH_EXT_NAME(glSecondaryColor3bv) = (PFNGLSECONDARYCOLOR3BVPROC)GLH_EXT_GET_PROC_ADDRESS("glSecondaryColor3bv");
        if (NULL == GLH_EXT_NAME(glSecondaryColor3bv))
            return GL_FALSE;
        GLH_EXT_NAME(glSecondaryColor3d) = (PFNGLSECONDARYCOLOR3DPROC)GLH_EXT_GET_PROC_ADDRESS("glSecondaryColor3d");
        if (NULL == GLH_EXT_NAME(glSecondaryColor3d))
            return GL_FALSE;
        GLH_EXT_NAME(glSecondaryColor3dv) = (PFNGLSECONDARYCOLOR3DVPROC)GLH_EXT_GET_PROC_ADDRESS("glSecondaryColor3dv");
        if (NULL == GLH_EXT_NAME(glSecondaryColor3dv))
            return GL_FALSE;
        GLH_EXT_NAME(glSecondaryColor3f) = (PFNGLSECONDARYCOLOR3FPROC)GLH_EXT_GET_PROC_ADDRESS("glSecondaryColor3f");
        if (NULL == GLH_EXT_NAME(glSecondaryColor3f))
            return GL_FALSE;
        GLH_EXT_NAME(glSecondaryColor3fv) = (PFNGLSECONDARYCOLOR3FVPROC)GLH_EXT_GET_PROC_ADDRESS("glSecondaryColor3fv");
        if (NULL == GLH_EXT_NAME(glSecondaryColor3fv))
            return GL_FALSE;
        GLH_EXT_NAME(glSecondaryColor3i) = (PFNGLSECONDARYCOLOR3IPROC)GLH_EXT_GET_PROC_ADDRESS("glSecondaryColor3i");
        if (NULL == GLH_EXT_NAME(glSecondaryColor3i))
            return GL_FALSE;
        GLH_EXT_NAME(glSecondaryColor3iv) = (PFNGLSECONDARYCOLOR3IVPROC)GLH_EXT_GET_PROC_ADDRESS("glSecondaryColor3iv");
        if (NULL == GLH_EXT_NAME(glSecondaryColor3iv))
            return GL_FALSE;
        GLH_EXT_NAME(glSecondaryColor3s) = (PFNGLSECONDARYCOLOR3SPROC)GLH_EXT_GET_PROC_ADDRESS("glSecondaryColor3s");
        if (NULL == GLH_EXT_NAME(glSecondaryColor3s))
            return GL_FALSE;
        GLH_EXT_NAME(glSecondaryColor3sv) = (PFNGLSECONDARYCOLOR3SVPROC)GLH_EXT_GET_PROC_ADDRESS("glSecondaryColor3sv");
        if (NULL == GLH_EXT_NAME(glSecondaryColor3sv))
            return GL_FALSE;
        GLH_EXT_NAME(glSecondaryColor3ub) = (PFNGLSECONDARYCOLOR3UBPROC)GLH_EXT_GET_PROC_ADDRESS("glSecondaryColor3ub");
        if (NULL == GLH_EXT_NAME(glSecondaryColor3ub))
            return GL_FALSE;
        GLH_EXT_NAME(glSecondaryColor3ubv) = (PFNGLSECONDARYCOLOR3UBVPROC)GLH_EXT_GET_PROC_ADDRESS("glSecondaryColor3ubv");
        if (NULL == GLH_EXT_NAME(glSecondaryColor3ubv))
            return GL_FALSE;
        GLH_EXT_NAME(glSecondaryColor3ui) = (PFNGLSECONDARYCOLOR3UIPROC)GLH_EXT_GET_PROC_ADDRESS("glSecondaryColor3ui");
        if (NULL == GLH_EXT_NAME(glSecondaryColor3ui))
            return GL_FALSE;
        GLH_EXT_NAME(glSecondaryColor3uiv) = (PFNGLSECONDARYCOLOR3UIVPROC)GLH_EXT_GET_PROC_ADDRESS("glSecondaryColor3uiv");
        if (NULL == GLH_EXT_NAME(glSecondaryColor3uiv))
            return GL_FALSE;
        GLH_EXT_NAME(glSecondaryColor3us) = (PFNGLSECONDARYCOLOR3USPROC)GLH_EXT_GET_PROC_ADDRESS("glSecondaryColor3us");
        if (NULL == GLH_EXT_NAME(glSecondaryColor3us))
            return GL_FALSE;
        GLH_EXT_NAME(glSecondaryColor3usv) = (PFNGLSECONDARYCOLOR3USVPROC)GLH_EXT_GET_PROC_ADDRESS("glSecondaryColor3usv");
        if (NULL == GLH_EXT_NAME(glSecondaryColor3usv))
            return GL_FALSE;
        GLH_EXT_NAME(glSecondaryColorPointer) = (PFNGLSECONDARYCOLORPOINTERPROC)GLH_EXT_GET_PROC_ADDRESS("glSecondaryColorPointer");
        if (NULL == GLH_EXT_NAME(glSecondaryColorPointer))
            return GL_FALSE;
        GLH_EXT_NAME(glBlendFuncSeparate) = (PFNGLBLENDFUNCSEPARATEPROC)GLH_EXT_GET_PROC_ADDRESS("glBlendFuncSeparate");
        if (NULL == GLH_EXT_NAME(glBlendFuncSeparate))
            return GL_FALSE;
        GLH_EXT_NAME(glWindowPos2d) = (PFNGLWINDOWPOS2DPROC)GLH_EXT_GET_PROC_ADDRESS("glWindowPos2d");
        if (NULL == GLH_EXT_NAME(glWindowPos2d))
            return GL_FALSE;
        GLH_EXT_NAME(glWindowPos2f) = (PFNGLWINDOWPOS2FPROC)GLH_EXT_GET_PROC_ADDRESS("glWindowPos2f");
        if (NULL == GLH_EXT_NAME(glWindowPos2f))
            return GL_FALSE;
        GLH_EXT_NAME(glWindowPos2i) = (PFNGLWINDOWPOS2IPROC)GLH_EXT_GET_PROC_ADDRESS("glWindowPos2i");
        if (NULL == GLH_EXT_NAME(glWindowPos2i))
            return GL_FALSE;
        GLH_EXT_NAME(glWindowPos2s) = (PFNGLWINDOWPOS2SPROC)GLH_EXT_GET_PROC_ADDRESS("glWindowPos2s");
        if (NULL == GLH_EXT_NAME(glWindowPos2s))
            return GL_FALSE;
        GLH_EXT_NAME(glWindowPos2dv) = (PFNGLWINDOWPOS2DVPROC)GLH_EXT_GET_PROC_ADDRESS("glWindowPos2dv");
        if (NULL == GLH_EXT_NAME(glWindowPos2dv))
            return GL_FALSE;
        GLH_EXT_NAME(glWindowPos2fv) = (PFNGLWINDOWPOS2FVPROC)GLH_EXT_GET_PROC_ADDRESS("glWindowPos2fv");
        if (NULL == GLH_EXT_NAME(glWindowPos2fv))
            return GL_FALSE;
        GLH_EXT_NAME(glWindowPos2iv) = (PFNGLWINDOWPOS2IVPROC)GLH_EXT_GET_PROC_ADDRESS("glWindowPos2iv");
        if (NULL == GLH_EXT_NAME(glWindowPos2iv))
            return GL_FALSE;
        GLH_EXT_NAME(glWindowPos2sv) = (PFNGLWINDOWPOS2SVPROC)GLH_EXT_GET_PROC_ADDRESS("glWindowPos2sv");
        if (NULL == GLH_EXT_NAME(glWindowPos2sv))
            return GL_FALSE;
        GLH_EXT_NAME(glWindowPos3d) = (PFNGLWINDOWPOS3DPROC)GLH_EXT_GET_PROC_ADDRESS("glWindowPos3d");
        if (NULL == GLH_EXT_NAME(glWindowPos3d))
            return GL_FALSE;
        GLH_EXT_NAME(glWindowPos3f) = (PFNGLWINDOWPOS3FPROC)GLH_EXT_GET_PROC_ADDRESS("glWindowPos3f");
        if (NULL == GLH_EXT_NAME(glWindowPos3f))
            return GL_FALSE;
        GLH_EXT_NAME(glWindowPos3i) = (PFNGLWINDOWPOS3IPROC)GLH_EXT_GET_PROC_ADDRESS("glWindowPos3i");
        if (NULL == GLH_EXT_NAME(glWindowPos3i))
            return GL_FALSE;
        GLH_EXT_NAME(glWindowPos3s) = (PFNGLWINDOWPOS3SPROC)GLH_EXT_GET_PROC_ADDRESS("glWindowPos3s");
        if (NULL == GLH_EXT_NAME(glWindowPos3s))
            return GL_FALSE;
        GLH_EXT_NAME(glWindowPos3dv) = (PFNGLWINDOWPOS3DVPROC)GLH_EXT_GET_PROC_ADDRESS("glWindowPos3dv");
        if (NULL == GLH_EXT_NAME(glWindowPos3dv))
            return GL_FALSE;
        GLH_EXT_NAME(glWindowPos3fv) = (PFNGLWINDOWPOS3FVPROC)GLH_EXT_GET_PROC_ADDRESS("glWindowPos3fv");
        if (NULL == GLH_EXT_NAME(glWindowPos3fv))
            return GL_FALSE;
        GLH_EXT_NAME(glWindowPos3iv) = (PFNGLWINDOWPOS3IVPROC)GLH_EXT_GET_PROC_ADDRESS("glWindowPos3iv");
        if (NULL == GLH_EXT_NAME(glWindowPos3iv))
            return GL_FALSE;
        GLH_EXT_NAME(glWindowPos3sv) = (PFNGLWINDOWPOS3SVPROC)GLH_EXT_GET_PROC_ADDRESS("glWindowPos3sv");
        if (NULL == GLH_EXT_NAME(glWindowPos3sv))
            return GL_FALSE;
#endif
...
#define glColorSubTable GLH_CORE_1_2_NAME(glColorSubTable)
#define glCopyColorSubTable GLH_CORE_1_2_NAME(glCopyColorSubTable)
#define glConvolutionFilter1D GLH_CORE_1_2_NAME(glConvolutionFilter1D)
#define glConvolutionFilter2D GLH_CORE_1_2_NAME(glConvolutionFilter2D)
#define glConvolutionParameterf GLH_CORE_1_2_NAME(glConvolutionParameterf)
#define glConvolutionParameterfv GLH_CORE_1_2_NAME(glConvolutionParameterfv)
#define glConvolutionParameteri GLH_CORE_1_2_NAME(glConvolutionParameteri)
#define glConvolutionParameteriv GLH_CORE_1_2_NAME(glConvolutionParameteriv)
#define glCopyConvolutionFilter1D GLH_CORE_1_2_NAME(glCopyConvolutionFilter1D)
#define glCopyConvolutionFilter2D GLH_CORE_1_2_NAME(glCopyConvolutionFilter2D)
#define glGetConvolutionFilter GLH_CORE_1_2_NAME(glGetConvolutionFilter)
#define glGetConvolutionParameterfv GLH_CORE_1_2_NAME(glGetConvolutionParameterfv)
#define glGetConvolutionParameteriv GLH_CORE_1_2_NAME(glGetConvolutionParameteriv)
#define glGetSeparableFilter GLH_CORE_1_2_NAME(glGetSeparableFilter)
#define glSeparableFilter2D GLH_CORE_1_2_NAME(glSeparableFilter2D)
#define glGetHistogram GLH_CORE_1_2_NAME(glGetHistogram)
#define glGetHistogramParameterfv GLH_CORE_1_2_NAME(glGetHistogramParameterfv)
#define glGetHistogramParameteriv GLH_CORE_1_2_NAME(glGetHistogramParameteriv)
#define glGetMinmax GLH_CORE_1_2_NAME(glGetMinmax)
#define glGetMinmaxParameterfv GLH_CORE_1_2_NAME(glGetMinmaxParameterfv)
#define glGetMinmaxParameteriv GLH_CORE_1_2_NAME(glGetMinmaxParameteriv)
#define glHistogram GLH_CORE_1_2_NAME(glHistogram)
#define glMinmax GLH_CORE_1_2_NAME(glMinmax)
#define glResetHistogram GLH_CORE_1_2_NAME(glResetHistogram)
#define glResetMinmax GLH_CORE_1_2_NAME(glResetMinmax)
...
#define glMultiTexCoord1d GLH_CORE_1_2_NAME(glMultiTexCoord1d)
#define glMultiTexCoord1dv GLH_CORE_1_2_NAME(glMultiTexCoord1dv)
#define glMultiTexCoord1f GLH_CORE_1_2_NAME(glMultiTexCoord1f)
#define glMultiTexCoord1fv GLH_CORE_1_2_NAME(glMultiTexCoord1fv)
#define glMultiTexCoord1i GLH_CORE_1_2_NAME(glMultiTexCoord1i)
#define glMultiTexCoord1iv GLH_CORE_1_2_NAME(glMultiTexCoord1iv)
#define glMultiTexCoord1s GLH_CORE_1_2_NAME(glMultiTexCoord1s)
#define glMultiTexCoord1sv GLH_CORE_1_2_NAME(glMultiTexCoord1sv)
#define glMultiTexCoord2d GLH_CORE_1_2_NAME(glMultiTexCoord2d)
#define glMultiTexCoord2dv GLH_CORE_1_2_NAME(glMultiTexCoord2dv)
#define glMultiTexCoord2f GLH_CORE_1_2_NAME(glMultiTexCoord2f)
#define glMultiTexCoord2fv GLH_CORE_1_2_NAME(glMultiTexCoord2fv)
#define glMultiTexCoord2i GLH_CORE_1_2_NAME(glMultiTexCoord2i)
#define glMultiTexCoord2iv GLH_CORE_1_2_NAME(glMultiTexCoord2iv)
#define glMultiTexCoord2s GLH_CORE_1_2_NAME(glMultiTexCoord2s)
#define glMultiTexCoord2sv GLH_CORE_1_2_NAME(glMultiTexCoord2sv)
#define glMultiTexCoord3d GLH_CORE_1_2_NAME(glMultiTexCoord3d)
#define glMultiTexCoord3dv GLH_CORE_1_2_NAME(glMultiTexCoord3dv)
#define glMultiTexCoord3f GLH_CORE_1_2_NAME(glMultiTexCoord3f)
#define glMultiTexCoord3fv GLH_CORE_1_2_NAME(glMultiTexCoord3fv)
#define glMultiTexCoord3i GLH_CORE_1_2_NAME(glMultiTexCoord3i)
#define glMultiTexCoord3iv GLH_CORE_1_2_NAME(glMultiTexCoord3iv)
#define glMultiTexCoord3s GLH_CORE_1_2_NAME(glMultiTexCoord3s)
#define glMultiTexCoord3sv GLH_CORE_1_2_NAME(glMultiTexCoord3sv)
#define glMultiTexCoord4d GLH_CORE_1_2_NAME(glMultiTexCoord4d)
#define glMultiTexCoord4dv GLH_CORE_1_2_NAME(glMultiTexCoord4dv)
#define glMultiTexCoord4f GLH_CORE_1_2_NAME(glMultiTexCoord4f)
#define glMultiTexCoord4fv GLH_CORE_1_2_NAME(glMultiTexCoord4fv)
#define glMultiTexCoord4i GLH_CORE_1_2_NAME(glMultiTexCoord4i)
#define glMultiTexCoord4iv GLH_CORE_1_2_NAME(glMultiTexCoord4iv)
#define glMultiTexCoord4s GLH_CORE_1_2_NAME(glMultiTexCoord4s)
#define glMultiTexCoord4sv GLH_CORE_1_2_NAME(glMultiTexCoord4sv)
#define glActiveTexture GLH_CORE_1_2_NAME(glActiveTexture)
#define glClientActiveTexture GLH_CORE_1_2_NAME(glClientActiveTexture)
#endif
#endif

#ifdef GL_VERSION_1_3
#define glCompressedTexImage3D GLH_EXT_NAME(glCompressedTexImage3D)
#define glCompressedTexImage2D GLH_EXT_NAME(glCompressedTexImage2D)
#define glCompressedTexImage1D GLH_EXT_NAME(glCompressedTexImage1D)
#define glCompressedTexSubImage3D GLH_EXT_NAME(glCompressedTexSubImage3D)
#define glCompressedTexSubImage2D GLH_EXT_NAME(glCompressedTexSubImage2D)
#define glCompressedTexSubImage1D GLH_EXT_NAME(glCompressedTexSubImage1D)
#define glGetCompressedTexImage GLH_EXT_NAME(glGetCompressedTexImage)
#define glSampleCoverage GLH_EXT_NAME(glSampleCoverage)
#define glLoadTransposeMatrixf GLH_EXT_NAME(glLoadTransposeMatrixf)
#define glLoadTransposeMatrixd GLH_EXT_NAME(glLoadTransposeMatrixd)
#define glMultTransposeMatrixf GLH_EXT_NAME(glMultTransposeMatrixf)
#define glMultTransposeMatrixd GLH_EXT_NAME(glMultTransposeMatrixd)
#endif

#ifdef GL_VERSION_1_4
#define glMultiDrawArrays GLH_EXT_NAME(glMultiDrawArrays)
#define glMultiDrawElements GLH_EXT_NAME(glMultiDrawElements)
#define glPointParameterf GLH_EXT_NAME(glPointParameterf)
#define glPointParameterfv GLH_EXT_NAME(glPointParameterfv)
#define glSecondaryColor3b GLH_EXT_NAME(glSecondaryColor3b)
#define glSecondaryColor3bv GLH_EXT_NAME(glSecondaryColor3bv)
#define glSecondaryColor3d GLH_EXT_NAME(glSecondaryColor3d)
#define glSecondaryColor3dv GLH_EXT_NAME(glSecondaryColor3dv)
#define glSecondaryColor3f GLH_EXT_NAME(glSecondaryColor3f)
#define glSecondaryColor3fv GLH_EXT_NAME(glSecondaryColor3fv)
#define glSecondaryColor3i GLH_EXT_NAME(glSecondaryColor3i)
#define glSecondaryColor3iv GLH_EXT_NAME(glSecondaryColor3iv)
#define glSecondaryColor3s GLH_EXT_NAME(glSecondaryColor3s)
#define glSecondaryColor3sv GLH_EXT_NAME(glSecondaryColor3sv)
#define glSecondaryColor3ub GLH_EXT_NAME(glSecondaryColor3ub)
#define glSecondaryColor3ubv GLH_EXT_NAME(glSecondaryColor3ubv)
#define glSecondaryColor3ui GLH_EXT_NAME(glSecondaryColor3ui)
#define glSecondaryColor3uiv GLH_EXT_NAME(glSecondaryColor3uiv)
#define glSecondaryColor3us GLH_EXT_NAME(glSecondaryColor3us)
#define glSecondaryColor3usv GLH_EXT_NAME(glSecondaryColor3usv)
#define glSecondaryColorPointer GLH_EXT_NAME(glSecondaryColorPointer)
#define glBlendFuncSeparate GLH_EXT_NAME(glBlendFuncSeparate)
#define glWindowPos2d GLH_EXT_NAME(glWindowPos2d)
#define glWindowPos2f GLH_EXT_NAME(glWindowPos2f)
#define glWindowPos2i GLH_EXT_NAME(glWindowPos2i)
#define glWindowPos2s GLH_EXT_NAME(glWindowPos2s)
#define glWindowPos2dv GLH_EXT_NAME(glWindowPos2dv)
#define glWindowPos2fv GLH_EXT_NAME(glWindowPos2fv)
#define glWindowPos2iv GLH_EXT_NAME(glWindowPos2iv)
#define glWindowPos2sv GLH_EXT_NAME(glWindowPos2sv)
#define glWindowPos3d GLH_EXT_NAME(glWindowPos3d)
#define glWindowPos3f GLH_EXT_NAME(glWindowPos3f)
#define glWindowPos3i GLH_EXT_NAME(glWindowPos3i)
#define glWindowPos3s GLH_EXT_NAME(glWindowPos3s)
#define glWindowPos3dv GLH_EXT_NAME(glWindowPos3dv)
#define glWindowPos3fv GLH_EXT_NAME(glWindowPos3fv)
#define glWindowPos3iv GLH_EXT_NAME(glWindowPos3iv)
#define glWindowPos3sv GLH_EXT_NAME(glWindowPos3sv)
#endif
