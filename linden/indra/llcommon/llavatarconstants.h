...
const char* const VISIBILITY_DEFAULT	= "default";
const char* const VISIBILITY_HIDDEN		= "hidden";
const char* const VISIBILITY_VISIBLE	= "visible";
const char* const VISIBILITY_INVISIBLE	= "invisible";
