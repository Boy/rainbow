 ...
 * @brief The LLFloaterMediaFilter class declaration
 *
...
#ifndef LL_LLFLOATERMEDIAFILTER_H
#define LL_LLFLOATERMEDIAFILTER_H
...
class LLFloaterMediaFilter : public LLFloater
{
public:
	LLFloaterMediaFilter();
	BOOL postBuild();
	virtual void draw();
	virtual ~LLFloaterMediaFilter();
...
private:
	...
	static LLFloaterMediaFilter* sInstance;
