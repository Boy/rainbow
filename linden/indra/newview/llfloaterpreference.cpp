	...
	mPrefsRainbow(NULL)
{
	...
	mPrefsRainbow = new LLPrefsRainbow();
	mTabContainer->addTabPanel(mPrefsRainbow->getPanel(), mPrefsRainbow->getPanel()->getLabel(), FALSE, onTabChanged, mTabContainer);
	mPrefsRainbow->getPanel()->setDefaultBtn(default_btn);
