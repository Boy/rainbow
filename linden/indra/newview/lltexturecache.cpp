...
void LLTextureCache::purgeTextures(bool validate)
{
	...
	LL_INFOS("TextureCache") << "TEXTURE CACHE: Reading " << num_entries << " Entries..." << LL_ENDL;  // VWR-3878 - NB 
	...
	S64 min_cache_size = sCacheMaxTexturesSize * 95 / 100;
	S32 purge_count = 0;
	S32 next_idx = 0;
	for (S32 idx=0; idx<num_entries; idx++)
	{
	...
	LL_INFOS("TextureCache") << "Writing Entries: " << num_entries 
